...
def fesvibs(
        ...
        epsilon, delta, resnet_dropout, initial_block, final_block
        ):
    ...
    if DP:
        ...
        mean=0
        dir_name = f"{model_name}_{lr}lr_{dataset_name}_{num_clients}Clients_{initial_block}to{final_block}Blocks_{batch_size}Batch__{epsilon,delta}DP_FeSViBS"
    else:
        mean = 0
        std = 0
        dir_name = f"{model_name}_{lr}lr_{dataset_name}_{num_clients}Clients_{initial_block}to{final_block}Blocks_{batch_size}Batch_FeSViBS"
...
if __name__ == "__main__":
    ...
    fesvibs(
        ...
        DP = args.DP, epsilon = args.epsilon, delta = args.delta, initial_block= args.initial_block, final_block=args.final_block, resnet_dropout = args.resnet_dropout
        )